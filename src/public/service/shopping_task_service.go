...
func NewShoppingTaskService(createShoppingTaskUsecase usecase.ICreateShoppingTaskUsecase, getTaskUsecase usecase.IGetTaskUsecase) IShoppingTaskService {
	return &ShoppingTaskService{createShoppingTaskUsecase, getTaskUsecase}
}
